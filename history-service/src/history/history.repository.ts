  ...
  export class HistoryRepository {
    ...
    async GetEventsByRoleId(
      ...
      try {
        ...
        const eventArr : EventArray = {events:[],totalCount:0,till:getDoneRequestsByRoleIdReq.to};
        ...
        const zeAmoorLehiyotBakashaRishona = '';
        
        if (zeAmoorLehiyotBakashaRishona === RequestType.CREATE_ROLE) {
