protoc --plugin=../node_modules/.bin/protoc-gen-ts_proto --ts_proto_out=./protocOutput ./proto/*.proto --proto_path=. --experimental_allow_proto3_optional --ts_proto_opt=esModuleInterop=true 
