...
export default class ProducerController {
    ...
    static async produceToKartoffelQueue(req: Request, res: Response) {
        ...
        producerClient.ProduceToKartoffelQueue({ id: req.body.id }, (err: any, response: SuccessMessage) => {
            if (err) {
                res.send(null);
            }
            res.send(response);
    ...
    static async produceToADQueue(req: Request, res: Response) {
        ...
        producerClient.ProduceToADQueue({ id: req.body.id }, (err: any, response: SuccessMessage) => {
            if (err) {
                res.send(null);
            }
            res.send(response);
