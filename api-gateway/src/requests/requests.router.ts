...
RequestsRouter.post('/createEntityRequest', RequestsController.createEntityRequest);
...
RequestsRouter.delete('/deleteRoleRequest', RequestsController.deleteRoleRequest);
