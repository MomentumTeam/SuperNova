...
export default class KartoffelController {
  ...
  static async getEntityByMongoId(req: Request, res: Response) {
    ...
    logger.info(`Call to getEntityByMongoId in GTW`, {
     ...
     try {
         const entity = await KartoffelService.getEntityById(getEntityByMongoIdReq);
         res.send(entity);
     } catch (error: any) {
         res.status(500).send(error.message);
     }
  ...
  static async getPictureByEntityId(req: any, res: Response) {
    ...
    try {
        const userImage = await KartoffelService.getPictureByEntityId(getPictureByEntityIdReq);
        res.send(userImage);
    } catch (error: any) {
        res.status(500).send(error.message);
    }
  ...
  static async searchEntitiesByFullName(req: Request, res: Response) {
    const searchEntitiesByFullNameReq: any = req.query;
      ...
      try {
          const entities = await KartoffelService.searchEntitiesByFullName(searchEntitiesByFullNameReq);
          res.send(entities);
      } catch (error: any) {
          res.status(500).send(error.message);
      }
  ...
  static async getEntityByIdentifier(req: Request, res: Response) {
    const getEntityByIdentifierReq: GetEntityByIdentifierRequest = { identifier: req.params.identifier };
     ...
     try {
         const entity = await KartoffelService.getEntityByIdentifier(getEntityByIdentifierReq);
         res.send(entity);
     } catch (error: any) {
         res.status(500).send(error.message);
     }
  ...
  static async getEntityByRoleId(req: Request, res: Response) {
    ...
    try {
        const entity = await KartoffelService.getEntityByRoleId(getEntityByRoleIdReq);
        res.send(entity);
    } catch (error: any) {
        res.status(500).send(error.message);
    }
  ...
  static async getEntitiesUnderOG(req: Request, res: Response) {
   ...
   try {
       const entities = await KartoffelService.getEntitiesUnderOG(getEntitiesUnderOGReq);
       res.send(entities);
   } catch (error: any) {
       res.status(500).send(error.message);
   }
  ...
  static async getEntitiesByHierarchy(req: Request, res: Response) {
    ...
    try {
      const entities = await KartoffelService.getEntitiesByHierarchy(getEntitiesByHierarchyReq);
      res.send(entities);
    } catch (error: any) {
      res.status(500).send(error.message);
    }
  ...
  static async getEntityByDI(req: Request, res: Response) {
    const getEntityByDI: GetEntityByDIRequest = { uniqueId: req.params.uniqueId };
  ...
  static async getOGByHierarchyName(req: Request, res: Response) {
    const getOGByHierarchyNameReq: GetOGByHierarchyNameRequest = { hierarchy: req.params.hierarchy };

    try {
        const og = await KartoffelService.getOGByHierarchyName(getOGByHierarchyNameReq);
        res.send(og);
    } catch (error: any) {
        res.status(500).send(error.message);
    }
  ...
  static async getRoleById(req: Request, res: Response) {
    const getRoleByIdReq: GetRoleByRoleIdRequest = { roleId: req.params.roleId };
