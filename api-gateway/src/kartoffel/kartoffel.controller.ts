...
import { OGArray, EntityArray, Entity, RoleArray, Role } from "../interfaces/protoc/proto/kartoffelService";
...
export default class KartoffelController {
    ...
    static async getEntityByIdNumber(req: Request, res: Response) {
        ...
        kartoffelClient.GetEntityByIdNumber({ idNumber: req.params.idNumber }, (err: any, response: Entity) => {
            if (err) {
                res.send(null);
            }
            res.send(response);
    ...
    static async searchRolesByRoleId(req: Request, res: Response) {
        ...
        kartoffelClient.SearchRolesByRoleId({ roleId: req.params.roleId }, (err: any, response: Role) => {
            if (err) {
                res.send(null);
            }
            res.send(response);
    ...
    static async getEntityByRoleId(req: Request, res: Response) {
        ...
        kartoffelClient.GetEntityByRoleId({ roleId: req.params.roleId }, (err: any, response: Entity) => {
            if (err) {
                res.send(null);
            }
            res.send(response);
    ...
    static async getChildrenOfOG(req: Request, res: Response) {
        ...
        kartoffelClient.GetChildrenOfOG({ id: req.params.id }, (err: any, response: OGArray) => {
            if (err) {
                res.send(null);
            }
            res.send(response);
