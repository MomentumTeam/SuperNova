...
export class ApproverService {
    static async getAllApprovers(getAllApproversReq: GetAllApproversReq) {
        ...
        return new Promise((resolve, reject) => {
            approverClient.GetAllApprovers(getAllApproversReq, (err: any, response: ApproverArray) => {
                if (err) {
    ...
    static async searchApproverByDisplayName(searchByDisplayNameReq: SearchByDisplayNameReq) {
        logger.info(`Call to SearchApproverByDisplayName in GTW`, searchByDisplayNameReq);

        return new Promise((resolve, reject) => {
            approverClient.SearchApproverByDisplayName(searchByDisplayNameReq, (err: any, response: ApproverArray) => {
                if (err) {
    ...
    static async searchApproverByDomainUser(searchByDomainUserReq: SearchByDomainUserReq) {
        logger.info(`Call to searchApproverByDomainUser in GTW`, searchByDomainUserReq);

        return new Promise((resolve, reject) => {
            approverClient.SearchApproverByDomainUser(searchByDomainUserReq, (err: any, response: ApproverArray) => {
                if (err) {
    ...
    static async getUserType(getUserTypeReq: GetUserTypeReq) {
        ...
        return new Promise((resolve, reject) => {
            approverClient.GetUserType(getUserTypeReq, (err: any, response: GetUserTypeRes) => {
                if (err) {
    ...
    static async addApprover(addApproverReq: AddApproverReq) {
        ...
        return new Promise((resolve, reject) => {
            approverClient.AddApprover(addApproverReq, (err: any, response: Approver) => {
                if (err) {
    ...
    static async updateApproverDecision(updateApproverDecisionReq: UpdateApproverDecisionReq) {
        ...
        return new Promise((resolve, reject) => {
            approverClient.UpdateApproverDecision(updateApproverDecisionReq, (err: any, response: ApproverArray) => {
                if (err) {
    ...
    static async deleteApprover(deleteApproverReq: DeleteApproverReq) {
        ...
        return new Promise((resolve, reject) => {
            approverClient.DeleteApprover(deleteApproverReq, (err: any, response: Approver) => {
                if (err) {
